...
\large Updated Results with Robustness Analysis}
...
The triple-difference coefficient (-0.0157, t = -1.20) is not statistically significant, indicating no differential effect on factory-relevant ages beyond what is observed for older teenagers.
