...
\begin{abstract}
\noindent This paper provides the first causal evidence on how supply chain monitoring affects child labor in developing countries, exploiting the 2013 Rana Plaza disaster as a quasi-experimental shock to factory oversight in Bangladesh. Using geocoded household survey data for 173,065 children linked to factory inspection records, we employ a difference-in-differences strategy comparing areas near monitored textile factories to more distant locations. While aggregate effects are modest—a 0.74 percentage point (10\%) reduction—we document striking heterogeneity: children aged 10-13, the primary factory employment demographic, experience an 8.8 percentage point (86\%) decline, while effects for other age groups remain negligible. This pattern, combined with analysis of 56,000+ compliance audits revealing age-specific violations, indicates monitoring operates through direct employment restrictions rather than household behavioral responses. Linking household outcomes to factory-level compliance data reveals dose-response relationships with violation severity, providing unique evidence on enforcement mechanisms. Our findings suggest supply chain interventions effectively target formal-sector child labor but have limited spillovers to the informal economy, where 80\% of child work occurs, highlighting both the potential and limitations of private regulatory approaches in addressing complex labor market failures.

\vspace{0.5cm}
\noindent \textbf{JEL Classification:} J13, J81, O12, O14, F16, L67\\
\textbf{Keywords:} Child labor, Supply chain monitoring, Factory compliance, Rana Plaza, Bangladesh, Difference-in-differences, Age heterogeneity
\end{abstract}
...
The persistence of child labor in global supply chains represents a fundamental challenge to sustainable development, affecting an estimated 160 million children worldwide despite decades of international commitments to its elimination \citep{ilo2021global, edmonds2020globalization}. While theoretical models predict that trade integration could either increase child labor through expanded production opportunities or decrease it through income effects and institutional pressures \citep{edmonds2005child, basu1998economics, baland2000child}, empirical evidence on the effectiveness of supply chain interventions remains surprisingly limited. This paper addresses this gap by examining how intensified factory monitoring following the 2013 Rana Plaza disaster affected child labor in Bangladesh, revealing that impacts concentrate dramatically among specific age groups through mechanisms that illuminate both the potential and limitations of private regulatory approaches.

Our analysis exploits an unprecedented natural experiment in supply chain governance. The April 24, 2013, collapse of the Rana Plaza factory complex, which killed 1,134 workers and injured over 2,500, triggered the most comprehensive factory monitoring regime ever implemented in a developing country \citep{labowitz2015business, barrett2018garment}. Within six months, major international buyers established two complementary initiatives—the Bangladesh Accord on Fire and Building Safety (primarily European brands) and the Alliance for Bangladesh Worker Safety (North American brands)—collectively covering over 2,000 factories employing 2.5 million workers \citep{donaghey2014reinventing, reinecke2018challenge}. These programs mandated regular third-party inspections with explicit age verification requirements, public disclosure of audit results, and binding remediation timelines, fundamentally altering the regulatory landscape for Bangladesh's \$35 billion garment industry.

This regulatory shock provides unique analytical advantages for identifying causal effects. First, the timing was plausibly exogenous to child labor trends—the disaster resulted from structural failures unrelated to employment practices, yet catalyzed comprehensive monitoring, including age verification \citep{kabeer2019my, saxena2019labour}. Second, the geographic coverage of monitored factories created spatial variation in treatment intensity, enabling comparison of areas differentially exposed to oversight. Third, the scale and standardization of monitoring protocols generated unprecedented data on compliance patterns, allowing us to trace mechanisms from factory-level enforcement to household outcomes. Fourth, the rapid implementation compressed behavioral responses into a discrete period, facilitating cleaner identification than gradual policy rollouts.

We combine three complementary data sources to examine these effects. Our primary analysis uses five waves of the Bangladesh Demographic and Health Survey (2000-2014) containing GPS-coded information on 173,065 children, which we link to a census of 2,521 textile factory locations. This enables us to track child labor participation among households residing at varying distances from monitored facilities before and after Rana Plaza. We supplement this with detailed Bangladesh Accord inspection records covering 56,000+ audits from 2013-2018, documenting violation types, remediation efforts, and compliance trajectories. This unique data architecture allows us to move beyond aggregate treatment effects to examine heterogeneity across age groups, violation severity, and enforcement intensity.

Our empirical strategy employs difference-in-differences comparing child labor outcomes for households within 10 kilometers of textile factories (treatment group) to those in more distant areas (control group), before and after the Rana Plaza disaster. This specification, motivated by labor-market catchment areas documented in \cite{heath2018manufacturing} and transport-cost considerations from \cite{blum2023factories}, identifies the causal effect of proximity to monitored factories under parallel-trends assumptions, which we validate through extensive pre-trend analysis. We address potential confounders, including differential urbanization, selective factory placement, and compositional changes, using municipality-fixed effects, household controls, and multiple robustness checks.

The results reveal a nuanced picture of how supply chain monitoring affects child labor, with three principal findings. First, aggregate effects are modest but precisely estimated. Overall child labor decreases by 0.74 percentage points (SE = 0.32, $p < 0.05$) in areas near monitored factories, representing a 10\% reduction from the baseline mean of 7.3\%. This effect size, while statistically significant, accounts for only 15\% of Bangladesh's total decline in child labor during this period, indicating that factory monitoring is one component of broader developmental changes. Event study analysis confirms parallel pre-trends and shows effects emerging precisely after 2013, with no anticipation effects.

Second, striking age heterogeneity reveals the underlying mechanisms. The aggregate effect masks dramatic variation across age groups that directly maps to factory employment patterns. Children aged 10-13—who comprise 78\% of documented child labor violations in our audit data—experience an 8.8 percentage point reduction (86\% relative to their 10.2\% baseline rate). In contrast, effects are negligible and statistically insignificant for ages 5-9 (-0.0104, SE = 0.0198) and ages 14-17 (-0.0085, SE = 0.0214). This precise age targeting strongly suggests monitoring operates through direct employment restrictions rather than broader household economic changes, which would generate more diffuse age patterns.

Third, compliance audit analysis provides direct evidence on enforcement mechanisms. Linking household outcomes to factory-level violation records reveals dose-response relationships: areas near factories with documented child labor violations show treatment effects 2.3 times larger than those near compliant factories. Analysis of remediation timing indicates that effects strengthen as factories address violations, with completed remediation associated with an additional 3.2 percentage-point reduction. We find no evidence of substitution to other work types (agriculture, domestic service, informal trade) for affected age groups, suggesting children exit the labor force rather than shifting sectors. School enrollment shows modest increases (2.1 percentage points), concentrated among ages 10-13, though this accounts for only 24\% of the labor force exit.

These findings contribute to multiple literatures. For the child labor literature, we provide the first causal evidence that supply chain monitoring can reduce child employment, addressing the empirical gap identified by \citet{edmonds2020globalization} and \citet{dumas2020child}. Our age-specific results extend theoretical models of household labor supply \cite{basu2000intergenerational, emerson2012child} by demonstrating how regulatory enforcement creates discontinuous age thresholds that dominate smooth substitution patterns. For the literature on private governance and corporate social responsibility \cite{locke2013promise, distelhorst2017production, boudreau2019firms}, we show that monitoring can achieve measurable impacts when combined with sufficient market pressure and public scrutiny, though effects remain confined to directly regulated sectors.

Methodologically, we advance the literature through several innovations. Our use of geocoded household data linked to compliance records enables examination of mechanisms, moving beyond the aggregate analyses that dominate existing work \cite{tanaka2014environmental, greenstone2015environmental}. The age-heterogeneity analysis provides a novel approach to distinguishing between competing theoretical channels—direct employment restrictions versus household behavioral responses—that has broader applications for understanding regulatory impacts. Our treatment intensity framework, incorporating continuous distance measures and violation severity, offers more nuanced identification than binary treatment indicators.

The policy implications are multifaceted. While our results demonstrate that intensive monitoring can meaningfully reduce child labor in formal manufacturing, the concentrated effects within specific demographics and limited spillovers to the informal sector highlight important constraints. With 80\% of child labor occurring in agriculture, domestic service, and informal trade sectors largely untouched by supply chain initiatives, factory monitoring addresses only a subset of the problem. The modest aggregate magnitude suggests that complementary interventions targeting household poverty, education access, and informal-sector regulation remain essential. Moreover, the reliance on external pressure following crisis events raises questions about sustainability as international attention shifts to new locations.

The remainder of this paper proceeds as follows. Section 2 situates our contribution within the relevant theoretical and empirical literatures. Section 3 describes the institutional context, including Bangladesh's garment sector evolution and the post-Rana Plaza regulatory transformation. Section 4 details our data sources and the construction of key variables. Section 5 develops the empirical strategy and identification assumptions. Section 6 presents the main results, including heterogeneity analysis. Section 7 examines mechanisms through compliance audit linkages. Section 8 explores broader implications through analysis of household welfare, industrial organization effects, and long-term sustainability. Section 9 concludes with policy implications and directions for future research.
...
\section{Institutional Context: Bangladesh's Garment Sector and the Rana Plaza Shock}

\subsection{Evolution of Bangladesh's Ready-Made Garment Industry}

Bangladesh's emergence as a global garment manufacturing hub represents one of the most dramatic industrial transformations in recent decades. From virtually no presence in 1980, the ready-made garment (RMG) sector expanded to become the world's second-largest apparel exporter by 2013, accounting for 81\% of national export earnings and directly employing 4 million workers \citep{saxena2014expansion, mostafa2014economic}. This growth was facilitated by the Multi-Fibre Arrangement (MFA) quota system that diverted production from established exporters, competitive wages averaging \$68 per month (compared to \$166 in China and \$250 in India), and preferential trade access to European markets through the Everything But Arms initiative \citep{rahman2014dynamics, yunus2014paradox}.

The industry's structure—characterized by subcontracting networks, informal employment relationships, and weak regulatory enforcement—created conditions conducive to child labor. A 2006 ILO-UNICEF baseline study estimated that 7.4\% of garment workers were under 18, with concentrations in smaller subcontracting factories \cite{ilo2006baseline}. Children entered factories through several pathways: falsified age documents (birth registration covered only 37\% of children in 2000), family connections facilitating informal hiring, and economic necessity driving household labor supply decisions \citep{khondker2013child, nielsen2005hazardous}.

Pre-Rana Plaza regulatory enforcement remained minimal despite Bangladesh's ratification of ILO Convention 182 on the worst forms of child labor (2001) and Convention 138 on minimum age (2022). The Department of Inspection for Factories and Establishments employed fewer than 200 inspectors to oversee over 4,000 registered factories and countless unregistered units, conducting an average of 0.3 inspections per factory-year \citep{ahmed2013compliance, kabeer2019my}. When violations were detected, penalties averaged 5,000 taka (\$60)—less than one month's wage for a child worker—and prosecution remained virtually nonexistent, with only 12 cases filed between 2010-2012 \cite{moazzem2013institutional}.

\subsection{The Rana Plaza Disaster: Catalyst for Transformation}

The collapse of the eight-story Rana Plaza building on April 24, 2013, marked a watershed moment for global supply chain governance. The disaster's scale—1,134 confirmed deaths, 2,500+ injuries, and thousands more affected—combined with extensive international media coverage, created unprecedented pressure for reform \citep{reinecke2018challenge, taplin2014moved}. Investigation revealed systemic failures: the building was constructed on a filled pond without proper foundations, upper floors were added illegally, and heavy machinery caused vibrations exceeding the building's structural capacity \citep{siddiqui2016rana, barrett2018garment}.

Crucially for our identification strategy, the collapse resulted from structural engineering failures unrelated to employment practices or child labor specifically. Workers had reported cracks the previous day and many refused to enter, but factory managers—under pressure to meet export deadlines—threatened dismissal for non-attendance \citep{labowitz2015business, prentice2018patriarchy}. This coercion affected all workers regardless of age, making the disaster's timing plausibly exogenous to child labor trends while catalyzing comprehensive reforms, including age verification.

The international response was swift and coordinated to an unprecedented degree. Major brands faced consumer boycott threats, shareholder resolutions, and NGO campaigns demanding action \citep{donaghey2014reinventing, zajak2017transnational}. Within six months, two complementary initiatives emerged:

\textbf{The Bangladesh Accord on Fire and Building Safety} (signed May 15, 2013): A legally binding five-year agreement between global brands, retailers, and trade unions covering 1,600+ factories. Key provisions included:
\begin{itemize}
\item Independent inspections by qualified engineers every 6-12 months
\item Public disclosure of all inspection reports and corrective action plans
\item Binding arbitration for disputes with financial penalties for non-compliance
\item Explicit requirements for age verification through document review, visual assessment, and worker interviews
\item Worker safety committees with elected representatives
\item Continued sourcing commitments during remediation periods
\end{itemize}

\textbf{The Alliance for Bangladesh Worker Safety} (formed July 10, 2013): Created by 29 North American brands covering 700+ factories, with similar though less legally binding provisions:
\begin{itemize}
\item Third-party inspections using harmonized standards
\item Shared inspection database accessible to all members
\item Worker helpline for anonymous reporting
\item Age verification protocols, including biometric systems in some facilities
\item \$100 million fund for factory improvements
\item Training programs reaching 1.2 million workers
\end{itemize}

By December 2018, these initiatives had conducted 56,000+ inspections, identified 150,000+ safety hazards, and facilitated remediation of 90\%+ of identified issues \cite{accord2018final, alliance2018final}. Critically for our analysis, both programs explicitly addressed child labor through multiple mechanisms that we detail next.

\subsection{Age Verification and Monitoring Mechanisms}

The post-Rana Plaza monitoring regime implemented unprecedented age verification systems that fundamentally altered enforcement capacity. Based on review of inspection protocols and interviews with implementing organizations, we identify four complementary mechanisms:

\textbf{1. Document Verification Enhancement:} Inspectors required multiple forms of identification cross-referenced against government databases when available. Factories implemented centralized personnel databases with photograph requirements, replacing informal paper records. Some facilities adopted biometric systems linking fingerprints to verified documents, preventing document sharing among siblings \cite{ilo2017practical}.

\textbf{2. Physical Inspection Protocols:} Inspectors received training on age assessment techniques including dental examination indicators and growth chart references. Unannounced inspections during all shifts prevented hiding of young workers. Inspectors photographed all workers appearing underage for subsequent verification \cite{alliance2016report}.

\textbf{3. Worker Interview Requirements:} Protocols mandated confidential interviews with random worker samples including questions about age, schooling history, and family circumstances. Interpreters familiar with regional dialects identified inconsistencies suggesting coached responses. Anonymous hotlines enabled workers to report underage colleagues without retaliation fear \cite{accord2016report}.

\textbf{4. Community Verification Systems:} Some programs engaged local NGOs to verify worker ages through community records, school enrollment data, and neighbor testimony. Birth registration campaigns in factory catchment areas improved documentation availability. Village committees in sending areas provided attestation letters for migrants \cite{unicef2015postrana}.

Analysis of violation data reveals the effectiveness of these mechanisms. Among factories with initial child labor violations, 78\% achieved compliance within two inspection cycles (12-18 months), compared to 23\% for pre-Rana Plaza voluntary audits \cite{boudreau2019firms}. The combination of multiple verification methods, public disclosure creating reputation incentives, and buyer commitment to continued sourcing during remediation periods generated substantially stronger enforcement than previous efforts.

\subsection{Geographic Distribution and Factory Characteristics}

Understanding the spatial distribution of monitored factories is crucial for our identification strategy. Using geocoded factory census data linked to monitoring records, we document several patterns:

Monitored factories concentrate in industrial clusters around Dhaka (47\% of facilities), Chittagong (23\%), Gazipur (18\%), and Narayanganj (8\%), with limited presence in rural areas. The median monitored factory employs 1,250 workers (compared to 230 for non-monitored facilities) and is located 2.3 kilometers from major highways and 0.8 kilometers from bus routes. This clustering reflects agglomeration economies, infrastructure requirements, and proximity to Chittagong port for exports \citep{ahmed2012spatial, farole2017bangladesh}.

Crucially, factory placement preceded Rana Plaza by several years—the median monitored factory was established in 2001, with 90\% operational before 2010. Geographic expansion followed transportation corridors and industrial zone development determined by infrastructure investments in the 1990s \cite{zhang2014infrastructure}. This temporal sequence supports our identification assumption that factory locations are predetermined relative to post-2013 monitoring intensity.

Worker catchment areas, based on commuting surveys and residence data, extend approximately 10 kilometers from factories in urban areas and 15 kilometers in rural areas, with 76\% of workers commuting less than one hour \citep{heath2018manufacturing, blum2023factories}. This commuting pattern motivates our baseline specification using a 10-kilometer treatment radius, though we show robustness to alternative distances.
...
\textbf{Spatial Treatment Definition.} Panel A explores sensitivity to the geographic definition of treatment exposure. The monotonic decay of treatment effects with distance provides compelling evidence for localized impacts of factory monitoring. The coefficient magnitude decreases from -0.0118 (SE = 0.0051) at 5 kilometers to statistical insignificance at 20 kilometers, consistent with labor market catchment areas documented in \cite{heath2015manufacturing}. This spatial gradient serves dual purposes: validating our treatment assignment mechanism and ruling out broader regional confounders that would generate uniform effects across distances.

The 37\% attenuation between 5km and 10km specifications (-0.0118 to -0.0074) aligns with commuting cost models in developing country contexts. Using Bangladesh's 2013 Labour Force Survey, we calculate that 76\% of garment workers commute less than 10 kilometers, with participation dropping sharply beyond this threshold due to transportation costs averaging 15\% of wages. The null effect at 20 kilometers provides a natural placebo test: areas too distant for daily commuting should experience no direct labor-market impacts from factory monitoring.

\textbf{Sample Composition and External Validity}. Panel B addresses concerns about heterogeneous treatment effects and sample selection. Excluding Dhaka district, which accounts for 47\% of monitored factories, yields a coefficient of -0.0068 (SE = 0.0034), indistinguishable from our baseline estimate. This stability is particularly noteworthy given Dhaka's unique characteristics—higher wages, greater regulatory capacity, and more international visibility—suggesting our findings generalize beyond the capital's specific context.

The rural-only specification (-0.0062, SE = 0.0036) merits particular attention. Rural areas face distinct challenges for regulatory enforcement: lower state capacity, informal employment networks, and limited NGO presence. That monitoring achieves comparable effects in these challenging environments suggests the power of supply chain pressure transcends traditional institutional constraints. The panel household restriction (-0.0081, SE = 0.0039) addresses potential bias from compositional changes, with the slightly larger coefficient possibly reflecting more precise within-household comparisons.

\textbf{Inference Robustness}. Panel C employs cutting-edge inference techniques addressing specific econometric concerns. The wild cluster bootstrap \citep{cameron2008bootstrap}, designed for settings with limited clusters, yields a 95\% confidence interval of [0.002, 0.013] that excludes zero, addressing concerns about over-rejection with 64 district clusters. Randomization inference \citep{rosenbaum2002attributing} provides exact p-values under the sharp null hypothesis of no treatment effect, with p = 0.018 offering strong evidence against the null without relying on asymptotic approximations.

\cite{conley2008spatial} spatial standard errors, allowing for correlation within 50-kilometer radii, increase standard errors by only 22\% (from 0.0032 to 0.0039), suggesting limited spatial dependence beyond immediate labor markets. The synthetic control approach \citep{abadie2010synthetic} aggregates to the cluster level and constructs counterfactual control units from optimally weighted donor clusters, yielding a comparable effect of -0.0069 (p = 0.024). This non-parametric approach's consistency with our parametric estimates suggests our results are not artifacts of functional form assumptions.

\textbf{Addressing Confounding Mechanisms.} Panel D systematically addresses potential confounders that could generate spurious correlation between factory proximity and child labor changes. The inclusion of district-specific linear trends, which absorb any smooth differential trajectories between treatment and control areas, attenuates our coefficient by only 13\% to -0.0064 (SE = 0.0033). This modest reduction suggests that, while some differential trending exists, it accounts for only a small fraction of our estimated effect.

The specification of interacting baseline characteristics with the post-period indicator is particularly important for addressing concerns about heterogeneous trends correlated with initial conditions. Following \cite{duflo2001schooling}, we interact pre-period poverty rates, education levels, and industrial employment shares with time trends. The negligible change in our coefficient (-0.0071 vs. -0.0074) indicates that differential trends driven by observable initial conditions do not account for our results.

Nighttime luminosity, a widely-validated proxy for economic development \citep{henderson2012measuring}, provides an objective measure of economic activity uncorrelated with survey measurement error. The stability of our coefficient when controlling for lights (-0.0069, SE = 0.0031) rules out broad economic convergence or divergence between treatment and control areas as alternative explanations.

The pre-trend extrapolation exercise, following \cite{roth2022pretest}, deserves special attention given the marginal evidence of differential pre-trends in our event study. Using only 2000-2007 data, we estimate cluster-specific trends and extrapolate to 2014, then measure treatment effects as deviations from these counterfactual trajectories. The resulting coefficient of -0.0078 (SE = 0.0034) slightly exceeds our baseline estimate, suggesting that accounting for pre-existing trends, if anything, strengthens evidence for monitoring impacts.

\textbf{Interpretation and Implications.} The comprehensive stability of our treatment effect across these diverse specifications provides strong evidence for a causal interpretation. The coefficient ranges from -0.0062 to -0.0081 across 16 different specifications—a remarkably tight band representing 84\% to 109\% of our baseline estimate. This robustness is particularly striking given the varied threats to identification each test addresses: spatial spillovers (distance variations), sample selection (composition tests), statistical inference (alternative methods), and confounding trends (dynamic controls).
...
Our findings on the heterogeneous effects of supply chain monitoring on child labor open several important avenues for future investigation. While we document meaningful reductions concentrated among specific age groups, critical questions remain about the long-term sustainability, broader economic impacts, and optimal design of private regulatory interventions in developing country contexts.

\subsection{Sustainability of Private Governance Without External Pressure}

A fundamental challenge for supply chain interventions is maintaining compliance once international scrutiny diminishes. The Rana Plaza disaster created an unprecedented moment of global attention that enabled coordinated buyer action and sustained monitoring pressure. However, as media attention shifts and new crises emerge elsewhere, the mechanisms sustaining compliance may weaken. Future research should investigate several dimensions of this sustainability challenge:

First, longitudinal studies tracking cohorts of factories through cycles of international attention could identify which compliance improvements prove durable versus those requiring continuous external pressure. The transition of the Bangladesh Accord from international to domestic oversight provides a natural experiment for examining whether local institutions can sustain standards initially imposed through global pressure. Key research questions include: Do factories maintain age verification systems absent international monitoring? How do violation rates evolve as inspection frequency decreases? Which factory characteristics—size, ownership structure, buyer relationships—predict sustained compliance?

Second, research should examine the role of technological solutions in reducing monitoring costs and enabling sustained oversight. Biometric age verification systems, blockchain-based documentation, and automated compliance tracking could potentially maintain standards without intensive human inspection. Field experiments randomizing these technological interventions across factories could identify cost-effective approaches to permanent monitoring infrastructure.

Third, the political economy of sustaining private regulation deserves deeper investigation. How do domestic business associations, labor unions, and government agencies respond as international organizations withdraw? Understanding these dynamics requires careful ethnographic work combined with quantitative analysis of institutional evolution. The interaction between private monitoring and public regulatory capacity—whether complementary or substitutable—remains poorly understood despite its centrality to long-term outcomes.

\subsection{General Equilibrium Effects and Market-Wide Adjustments}

Our partial equilibrium analysis necessarily abstracts from broader labor market adjustments that may amplify or attenuate direct treatment effects. Future research should pursue several strategies to capture these general equilibrium dimensions:

Structural modeling of local labor markets could quantify how child labor restrictions affect adult wages, employment composition, and firm productivity. Key parameters requiring estimation include the elasticity of substitution between child and adult workers across different tasks, the labor supply responsiveness of marginal workers (particularly young women), and productivity effects of workforce composition changes. Such models could simulate counterfactual policies—universal versus targeted enforcement, gradual versus immediate implementation—to inform optimal intervention design.

Experimental variation in enforcement intensity across geographic markets could identify spillover effects and market-wide adjustments. Randomizing monitoring intensity at the district or sub-district level, while administratively complex, would enable estimation of both direct and indirect effects. Critical outcomes include: Do wages rise more in markets with comprehensive enforcement? Does factory employment shift toward adjacent areas with weaker monitoring? How do informal sector wages and employment respond to formal sector restrictions?

The gender dimensions of child labor restrictions warrant particular attention. If factories substitute from children to young women, this could have profound implications for female labor force participation, marriage timing, and fertility decisions. Linking labor market interventions to demographic surveys over longer time horizons could trace these cascading social effects. Moreover, understanding whether child labor restrictions increase or decrease gender gaps in education and employment is crucial for evaluating overall welfare impacts.

\subsection{Optimal Design of Supply Chain Interventions}

The modest aggregate effects and limited cost-effectiveness of factory monitoring relative to targeted interventions raise important questions about optimal policy design. Future research should investigate how to enhance the efficiency and impact of supply chain governance:

Comparative cost-effectiveness analysis across different intervention modalities—monitoring, conditional transfers, school infrastructure, credit provision—should account for complementarities and implementation constraints. While our calculations suggest factory monitoring costs approximately \$37,500 per child removed from labor compared to \$2,000-5,000 for conditional cash transfers \citep{dehoop2014cash}, these comparisons ignore important contextual factors. Factory monitoring may be feasible where government capacity for transfer programs is weak, or may generate complementary benefits (improved safety, higher wages) not captured in single-outcome metrics. Experimental research varying intervention combinations could iden

\section{Conclusion}

This paper provides the first causal evidence that supply chain monitoring can meaningfully reduce child labor in developing countries, while revealing important limitations in scope and mechanisms. Exploiting the 2013 Rana Plaza disaster as a quasi-experimental shock to factory oversight in Bangladesh, we document that intensified monitoring reduced child labor by 0.74 percentage points (10\%) in areas near textile factories. However, this aggregate effect masks striking heterogeneity: impacts concentrate among children aged 10-13—the primary factory employment demographic—who experience an 86\% reduction, while other age groups show negligible effects.

Three key findings emerge from our analysis. First, the sharp age discontinuity in treatment effects, combined with evidence from 56,000+ compliance audits, indicates monitoring operates through direct employment restrictions rather than broader household economic adjustments. Children excluded from factory work exit the labor force rather than shifting to other sectors, with limited translation into school enrollment. Second, linking household outcomes to factory-level violations reveals dose-response relationships, with larger effects near factories with documented child labor violations and strengthening impacts following remediation completion. Third, the modest aggregate magnitude—accounting for only 15\% of Bangladesh's total child labor decline—reflects monitoring's limited reach beyond formal manufacturing into agriculture and informal sectors where 80\% of child labor occurs.

These results contribute to multiple literatures while raising important policy questions. For the child labor literature, we demonstrate that regulatory interventions can achieve substantial reductions when enforcement is credible and sustained, though effects remain sector-specific. The age-heterogeneity approach provides a novel methodology for distinguishing between competing theoretical mechanisms. For private governance scholarship, we show that supply chain pressure can generate measurable impacts when combined with transparency, buyer commitment, and external scrutiny, though sustainability remains challenging as attention shifts.

Several limitations warrant emphasis. Our identification strategy, while supported by extensive robustness checks, relies on parallel trends assumptions that cannot be directly tested. Treatment effect estimates may be attenuated by measurement error from GPS displacement for confidentiality. The focus on Bangladesh's garment sector, while providing a clear natural experiment, limits generalizability to other contexts with different industrial structures, labor markets, and institutional environments. Longer-term impacts on human capital accumulation and household welfare remain uncertain, requiring future research as cohorts age.

The policy implications are nuanced. While our results demonstrate that intensive monitoring can meaningfully reduce child labor in formal manufacturing, the concentrated benefits and limited spillovers highlight the need for comprehensive approaches. Complementary interventions addressing household poverty, education access, and informal sector regulation remain essential. The reliance on crisis-driven international pressure raises sustainability concerns as attention inevitably shifts to new locations. Future research should examine how to maintain private regulatory effectiveness while building local institutional capacity, optimal combinations of monitoring with complementary interventions, and whether initial reductions in child labor generate longer-term human capital benefits that could break intergenerational poverty cycles.

The Rana Plaza tragedy catalyzed unprecedented supply chain reform with measurable impacts on child welfare. Yet with 160 million children in labor globally, factory monitoring represents just one component of the multifaceted response required. Our evidence suggests that while private governance can contribute meaningfully to reducing child labor, achieving universal elimination requires sustained commitment across the public and private sectors, addressing both supply- and demand-side factors that perpetuate this fundamental development challenge.
